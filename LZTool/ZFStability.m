...
#import "ZFStability.h"
#import <objc/runtime.h>
#import <UIKit/UIKit.h>

////////////////////////////////////////////////////////////////

@interface ZFStabilityLogs : NSObject
...
@implementation ZFStabilityLogs
                 ...
                 otherLog:(NSString *)otherLog
{
    ...
    if ([ZFNonEmpty isString:otherLog]) {
...
{
    NSAssert((anObject && [self containsObject:anObject]),([ZFStabilityLogs crashReason:@"元素不存在"
                                                                                 release:@"返回0"
                                                                                otherLog:nil]));
...
{
    NSAssert((index < self.count),([ZFStabilityLogs crashReason:@"数组越界"
                                                         release:@"返回nil"
...
{
    NSAssert((anObject), ([ZFStabilityLogs crashReason:@"被添加的元素不存在"
                                                release:@"不执行该方法"
                                               otherLog:nil]));
    if (anObject) {
...
{
    NSAssert((index < self.count), ([ZFStabilityLogs crashReason:@"被移除的元素index越界"
                                                          release:@"不执行该方法"
                                                         otherLog:nil]));
...
@implementation NSDictionary (ZFStability)
...
- (NSString *)getStringForKey:(id)key
{
    ...
    NSAssert(([obj isKindOfClass:[NSString class]] || [obj isKindOfClass:[NSNumber class]]),
             ([ZFStabilityLogs crashReason:@"无法获取NSString类型"
                                    release:@"返回@"""
...
- (NSArray *)getArrayForKey:(id)key
{
    ...
    NSAssert(([obj isKindOfClass:[NSString class]]),
             ([ZFStabilityLogs crashReason:@"无法获取NSArray类型"
...
- (NSDictionary *)getDictinaryForKey:(id)key
{
    ...
    NSAssert(([obj isKindOfClass:[NSDictionary class]]),
             ([ZFStabilityLogs crashReason:@"无法获取NSDictionary类型"
...
- (int)getIntForKey:(id)key
{
    ...
    NSAssert(([obj isKindOfClass:[NSString class]] || [obj isKindOfClass:[NSNumber class]]),
             ([ZFStabilityLogs crashReason:@"不是NSString或NSNumber，无法转化成int类型"
                                    release:@"返回0"
                                   otherLog:[NSString stringWithFormat:@"得到的类型是：%@",
                                             NSStringFromClass([obj class])]]));
...
- (float)getFloatForKey:(id)key
{
    ...
    NSAssert(([obj isKindOfClass:[NSString class]] || [obj isKindOfClass:[NSNumber class]]),
             ([ZFStabilityLogs crashReason:@"不是NSString或NSNumber，无法转化成float类型"
                                    release:@"返回0"
                                   otherLog:[NSString stringWithFormat:@"得到的类型是：%@",
                                             NSStringFromClass([obj class])]]));
...
- (BOOL)getBoolForKey:(id)key
{
    ...
    NSAssert(([obj isKindOfClass:[NSString class]] || [obj isKindOfClass:[NSNumber class]]),
             ([ZFStabilityLogs crashReason:@"不是NSString或NSNumber，无法转化成BOOL类型"
                                    release:@"返回NO"
                                   otherLog:[NSString stringWithFormat:@"得到的类型是：%@",
                                             NSStringFromClass([obj class])]]));
...
- (void)safeSetObject:(id)anObject forKey:(id <NSCopying>)aKey;
{
    ...
    NSAssert((anObject), ([ZFStabilityLogs crashReason:@"被添加的object不存在"
                                                release:@"不执行该方法"
                                               otherLog:nil]));
    
    NSAssert((aKey), ([ZFStabilityLogs crashReason:@"被添加的key不存在"
                                                release:@"不执行该方法"
                                               otherLog:nil]));
